...
int SoftapController::setSoftap(int argc, char *argv[]) {
    ...
    if (argc < 5) {
        ALOGE("Softap set is missing arguments. Please use: softap <wlan iface> <softap iface> <SSID> <wpa2?-psk|open> <passphrase>");
    ...
    char *iface = argv[2 /* The first index for wlan iface, don't change */];
    char *wbuf = NULL;
    char *fbuf = NULL;
